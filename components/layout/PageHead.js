    ...
    <>
      <Head>
        <title>
          {headTitle
            ? headTitle
            : "Elite Spa Dhaka || Dhaka's Premier Destination for Luxury Spa"}
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Elite Spa Dhaka - Feel Premium and Luxury "
        />
        <meta
          property="og:description"
          content="Discover Dhaka's premier destination for luxury spa and wellness. Indulge in exclusive treatments, relax in a serene atmosphere, and rejuvenate your mind and body with our professional services."
        />
        <meta property="og:image" content="images/image 2.png" />
        <meta property="og:url" content="elitespadhaka.com" />
